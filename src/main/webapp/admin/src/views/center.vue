<template>
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="用户账号" prop="yonghuzhanghao">
          <el-input v-model="ruleForm.yonghuzhanghao" readonly              placeholder="用户账号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="用户姓名" prop="yonghuxingming">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="手机号码" prop="shoujihaoma">
          <el-input v-model="ruleForm.shoujihaoma"               placeholder="手机号码" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="身份证号" prop="shenfenzhenghao">
