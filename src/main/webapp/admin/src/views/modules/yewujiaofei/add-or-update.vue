	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="缴费月份" prop="jiaofeiyuefen">
					<el-input v-model="ruleForm.jiaofeiyuefen" placeholder="缴费月份" clearable  :readonly="ro.jiaofeiyuefen"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' v-else class="input" label="缴费月份" prop="jiaofeiyuefen">
					<el-input v-model="ruleForm.jiaofeiyuefen" placeholder="缴费月份" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="缴费时间" prop="jiaofeishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.jiaofeishijian" label="缴费时间" prop="jiaofeishijian">
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yewujiaofei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yewujiaofeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
